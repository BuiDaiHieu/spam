...
def checker():
    if token == "":
        ...
        return False
    if channel == "":
        print("Please insert channel id")
        return False
    else: 
        return True

def sendTime():
    return strftime("%d %b %Y %H:%M:%S", localtime()) + " " + "[SENT]"
